...
app = dash.Dash(__name__, server=True, url_base_pathname='/dashapp/', external_stylesheets=[dbc.themes.BOOTSTRAP])
...
application = app.server  # importante para WSGI de Django
